...
void Application::CameraRotation(float a_fSpeed)
{
	...
	SetCursorPos(CenterX, CenterY);//Position the mouse in the center
	m_pCamera->CalculationHelper(fAngleX, fAngleY); //send floats over to camera helper function
}
//Keyboard
...
#pragma region Camera Position
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::W))
		m_pCamera->MoveForward(-fSpeed); //speed is neagtive
	else if (sf::Keyboard::isKeyPressed(sf::Keyboard::S))
		m_pCamera->MoveForward(fSpeed);
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::A)) //left and right controls
