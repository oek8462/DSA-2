...
void MyMesh::GenerateCylinder(float a_fRadius, float a_fHeight, int a_nSubdivisions, vector3 a_v3Color)
{
	...
	for (int i = 0; i < a_nSubdivisions; i++)
	{
		...
		float x2 = a_fRadius * cos(angle * (i + 1));
		float y2 = a_fRadius * sin(angle * (i + 1));
		vector3 a = vector3(x, y, -a_fHeight/2);
...
void MyMesh::GenerateTube(float a_fOuterRadius, float a_fInnerRadius, float a_fHeight, int a_nSubdivisions, vector3 a_v3Color)
{
	...
	for (int i = 0; i < a_nSubdivisions; i++)
	{
		...
		AddQuad(vector3(outerX, outerY, -a_fHeight/2), vector3(outerX2, outerY2, -a_fHeight/2), vector3(outerX, outerY, a_fHeight/2), vector3(outerX2, outerY2, a_fHeight/2));

		AddQuad(vector3(x,y, -a_fHeight / 2), vector3(x2,y2, -a_fHeight / 2), vector3(outerX, outerY, -a_fHeight / 2), vector3(outerX2, outerY2, -a_fHeight / 2));
		AddQuad(vector3(x2, y2, a_fHeight/2), vector3(x, y, a_fHeight/2),vector3(outerX2, outerY2, a_fHeight/2), vector3(outerX, outerY, a_fHeight/2));
	}
...
void MyMesh::GenerateSphere(float a_fRadius, int a_nSubdivisions, vector3 a_v3Color)
{
	...
	for (int i = 0; i < a_nSubdivisions; i++)
	{
		...
		{
			//front
			verticies.push_back(vector3(-fValue + (j * subLength) , -fValue + (i * subLength), fValue));
			verticies.push_back(vector3((-fValue + subLength) + (j * subLength), -fValue + (i * subLength), fValue));
			verticies.push_back(vector3(-fValue + (j * subLength), (-fValue + subLength) + (i * subLength), fValue));
			verticies.push_back(vector3((-fValue  + subLength) + (j * subLength), (-fValue + subLength) + (i * subLength), fValue));

			////top
			verticies.push_back(vector3(-fValue + (j * subLength), fValue , fValue - (i * subLength)));
			verticies.push_back(vector3((-fValue + subLength) + (j * subLength), fValue , fValue - (i * subLength)));
			verticies.push_back(vector3(-fValue + (j * subLength), fValue , (fValue - subLength) - (i * subLength)));
			verticies.push_back(vector3((-fValue + subLength) + (j * subLength), fValue , (fValue - subLength) - (i * subLength)));
			...
			////left
			verticies.push_back(vector3(-fValue, (-fValue + subLength) + (i * subLength), fValue - (j * subLength)));
			verticies.push_back(vector3(-fValue, (-fValue + subLength) + (i * subLength), (fValue - subLength) - (j * subLength)));
			verticies.push_back(vector3(-fValue, -fValue + (i * subLength), fValue - (j * subLength)));
			verticies.push_back(vector3(-fValue , -fValue + (i * subLength), (fValue - subLength) - (j * subLength)));
